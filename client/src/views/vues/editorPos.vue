                ...
                <div class="col-md-6">
                    ...
                    <div v-if="image&&!isData" id="inputs">
                        <div>
                            ...
                            {{ shaftNumX }}
                            x축을 입력해주세요.
                            <button type="button" @click="addShaft(true, 'init', 0)">축 추가</button>
                            <div id="xShaft"></div>
                        </div>
                        <div>
                            개수 :
                            {{ shaftNumY }}
                            y축을 입력해주세요.
                            <button type="button" @click="addShaft(false, 'init', 0)">축 추가</button>
                            <div id="yShaft"></div>
                        </div>
